...
#         township = self.env['res.country.township'].search([('zip','=',self.zip)])
#         if township:
#             self.township_id = township[0].id
#             self.province_id = township[0].province_id and township[0].province_id.id
#             self.district_id = township[0].district_id and township[0].district_id.id
#             self.country_id = township[0].country_id and township[0].country_id.id
