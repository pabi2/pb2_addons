"""
This method will click button sign document in loan agreement
"""
import sys
import os
try:
...
logger = log.setup_custom_logger('loan_agreement_act_sign_document')
logger.info('Start process')
logger.info('Total loan agreement: %s' % len(loan_agreements))
for loan_agreement in loan_agreements:
    try:
        LoanAgreement.mork_action_sign([loan_agreement['id']])
