"""
This method will click button approve in project construction phase.
"""
import sys
import os
try:
...
log_pcp_codes = [[], []]
logger = log.setup_custom_logger('project_construction_phase_act_approve')
logger.info('Start process')
logger.info('Total project construction phase: %s' % len(pcps))
for pcp in pcps:
    try:
        ProjectPhase.mork_action_approve([pcp['id']])
