...
class TestInvoiceActivity(common.TransactionCase):
    ...
    def setUp(self):
        ...
        self.activity_group_travel = \
            self.env.ref('accoun_budget_activity.data_activity_group_travel')
        self.activity_taxi = \
            self.env.ref('accoun_budget_activity.data_activity_taxi')
        self.activity_plane = \
            self.env.ref('accoun_budget_activity.data_activity_plane')
