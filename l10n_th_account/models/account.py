...
class AccountTax(models.Model):
    ...
    def compute_all(self, cr, uid, taxes, price_unit, quantity, product=None,
        ...
        # === Code Overwrite from account.tax original compute_all ===
        precision = self.pool.get('decimal.precision').\
            precision_get(cr, uid, 'Account')
        tax_compute_precision = precision
        # kittiu: Add special condition - force_tax_rounding_method
        rounding_method = context.get('force_tax_rounding_method', False) or \
