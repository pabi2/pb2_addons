          ...
          %if display_account_raw(data) == 'all' or (display_ledger_lines or display_initial_balance):
            ...
            <div class="act_as_table list_table" style="margin-top: 10px;">
                ...
                <div class="act_as_thead">
                    <div class="act_as_row labels">
                        ## document date
                        <div class="act_as_cell first_column" style="width: 50px;">${_('Document Date')}</div>
                        ## posting date
                        <div class="act_as_cell" style="width: 50px;">${_('Posting Date')}</div>
                        ## period
                        <div class="act_as_cell" style="width: 50px;">${_('Period')}</div>
                        ## budget
                        <div class="act_as_cell" style="width: 100px;">${_('Budget')}</div>
                        ## fund
                        <div class="act_as_cell" style="width: 50px;">${_('Fund')}</div>
                        ## costcenter
                        <div class="act_as_cell" style="width: 100px;">${_('Costcenter')}</div>
                        ## taxbranch
                        <div class="act_as_cell" style="width: 100px;">${_('Tax Branch')}</div>
                        ## move
                        <div class="act_as_cell" style="width: 100px;">${_('Entry')}</div>
                        ## doctype
                        <div class="act_as_cell" style="width: 50px;">${_('DocType')}</div>
                        ## activity group
                        <div class="act_as_cell" style="width: 100px;">${_('Activity Group')}</div>
                        ## activity
                ...
                <div class="act_as_tbody">
                      ...
                      <div class="act_as_row lines">
                          ## document date
                          <div class="act_as_cell first_column">${formatLang(line.get('document_date') or '', date=True)}</div>
                          ## posting date
                          <div class="act_as_cell">${formatLang(line.get('ldate') or '', date=True)}</div>
                          ## period
                          <div class="act_as_cell">${line.get('period_code') or ''}</div>
                          ## budget
                          <div class="act_as_cell">${line.get('budget_name') or ''}</div>
                          ## fund
                          <div class="act_as_cell">${line.get('fund_name') or ''}</div>
                          ## costcenter
                          <div class="act_as_cell">${line.get('costcenter_name') or ''}</div>
                          ## taxbranch
                          <div class="act_as_cell">${line.get('taxbranch_name') or ''}</div>
                          ## move
