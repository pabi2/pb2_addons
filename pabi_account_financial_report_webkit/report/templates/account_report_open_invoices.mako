...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <% template1 = helper.get_mako_template('pabi_account_financial_report_webkit','report', 'templates', 'open_invoices_inclusion.mako.html') %>
    <% context.lookup.put_template('open_invoices_inclusion.mako.html', template1) %>
    <% template2 = helper.get_mako_template('pabi_account_financial_report_webkit','report', 'templates', 'grouped_by_curr_open_invoices_inclusion.mako.html') %>
