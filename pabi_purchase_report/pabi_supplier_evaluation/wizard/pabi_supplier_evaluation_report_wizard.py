...
class PabiSupplierEvaluationReportWizard(models.TransientModel):
    ...
    def run_report(self):
        data = {'parameters': {}}
        report_name = self.format == 'pdf' and 'pabi_supplier_evaluation_report' or \
            'pabi_supplier_evaluation_report_xls'
